...
class Solution:
    ...
    def removeLoop(self, head):
        ...
        if not head or not head.next:
            return True  # No loop possible in an empty or single-node list
        ...
        if not loop_found:
            return True  # No loop found, return true
        ...
        temp.next = None  # Remove the loop by breaking the connection
